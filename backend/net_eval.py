...
if __name__ == "__main__":
    ...
    mobnet_model_file = dir_path + "/saved_models/mobilenet/v1/mobilenet_output_graph.pb"
    mobnet_label_file = dir_path + "/saved_models/mobilenet/v1/mobilenet_output_labels.txt"
    ...
    incptn_model_file = dir_path + "/saved_models/inception/v1/inception_output_graph.pb"
    incptn_label_file = dir_path + "/saved_models/inception/v1/inception_output_labels.txt"
